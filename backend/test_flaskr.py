...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "postgresql://postgres:1996@localhost:5432/trivia_test" # I changed the DB bath because I faced problem
...
# Test Get Categories API 
 ...
 # Test Get Questions API 
    ...
    def test_404_sent_requesting_beyond_valid_page(self): # Test for expected error
 ...
 # Test Search for Questions API   
    ...
    def test_404_search_questions(self): # Test for expected error
        ...
        res = self.client().post('/questions/search', json={'searchTerm': 'TTTTTTT'})
        data = json.loads(res.data)
